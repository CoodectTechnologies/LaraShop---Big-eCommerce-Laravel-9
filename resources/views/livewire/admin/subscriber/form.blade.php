    ...
    <div>
        ...
        <form class="form" wire:submit.prevent="{{ $method }}">
            ...
            <div class="fv-row mb-7">
                ...
                <input type="email" required wire:model.defer="subscriber.email" class="form-control form-control-solid @error('subscriber.email') invalid-feedback @enderror" placeholder="Ejem: fulano@gmail.com" name="" />

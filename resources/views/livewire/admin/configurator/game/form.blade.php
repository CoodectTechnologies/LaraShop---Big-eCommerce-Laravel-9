<div>
    ...
    <form class="form" wire:submit.prevent="{{ $method }}">
                ...
                <div class="mt-1">
                    ...
                    <div class="image-input image-input-outline">
                        ...
                        <div
                            ...
                            @else
                                style="background-image: url('{{ $configuratorGame->imagePreview() }}')"
                            @endif
                        ></div>
        ...
        <div class="fv-row mb-7">
            ...
            <input required wire:model.defer="configuratorGame.name" class="form-control form-control-solid @error('configuratorGame.name') invalid-feedback @enderror" placeholder="Ejem: Modern Warfare 3" name="" />
            @error('configuratorGame.name') <small  class="form-text text-danger" role="alert">{{ $message }}</small> @enderror
        </div>
        <!--end::Input group-->
        <!--begin::Actions-->

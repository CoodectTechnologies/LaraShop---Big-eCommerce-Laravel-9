    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                ...
                <!--begin::Button-->
                <a href="{{ route('admin.catalog.category.create') }}" class="btn btn-light-primary">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5">
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        ...
                        <tr>
                            ...
                            <td class="">
                                <!--begin::Update-->
                                <a href="{{ route('admin.catalog.category.edit', $category) }}" class="btn btn-icon btn-active-light-success w-30px h-30px me-3">

    ...
    <div>
        ...
        <form class="form" wire:submit.prevent="{{ $method }}">
            ...
            <div class="fv-row mb-7">
                ...
                <input type="text" required wire:model.defer="brand.name.{{ translatable() }}" class="form-control form-control-solid @error('brand.name.{{ translatable() }}') invalid-feedback @enderror" placeholder="{{ __('Brand name') }}" name="" />
                @error('brand.name.{{ translatable() }}') <small  class="form-text text-danger" role="alert">{{ $message }}</small> @enderror
            </div>
            <!--end::Input group-->
            <!--begin::Actions-->

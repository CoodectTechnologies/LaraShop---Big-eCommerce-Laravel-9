<!--begin::Delete-->
<button onclick="event.preventDefault(); confirmDestroyConfiguratorCompatibility({{ $configuratorCompatibility->id }})" class="btn btn-icon btn-active-light-danger w-30px h-30px">

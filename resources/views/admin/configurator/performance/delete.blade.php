<!--begin::Delete-->
<button onclick="event.preventDefault(); confirmDestroyConfiguratorPerformance({{ $configuratorPerformance->id }})" class="btn btn-icon btn-active-light-danger w-30px h-30px">

    ...
    <div class="modal-dialog modal-dialog-centered mw-750px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 my-7">
                ...
                <p>{{ __('Email') }}: <i class="fa fa-envelope"></i> <a href="mailto:{{ $emailWeb->email }}">{{ $emailWeb->email }}</a></p>
                <p>Asunto: {{ $emailWeb->subject }}</p>
                <p>{{ __('Phone') }}: <i class="fa fa-phone"></i> <a href="tel:{{ $emailWeb->phone }}" target="_blank" rel="noopener noreferrer">{{ $emailWeb->phone }}</a></p>
